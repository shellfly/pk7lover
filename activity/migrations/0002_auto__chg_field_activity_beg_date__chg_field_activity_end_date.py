...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.beg_date'
        db.alter_column('activity_activity', 'beg_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Activity.end_date'
        db.alter_column('activity_activity', 'end_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Activity.beg_date'
        db.alter_column('activity_activity', 'beg_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Activity.end_date'
        db.alter_column('activity_activity', 'end_date', self.gf('django.db.models.fields.DateTimeField')())
