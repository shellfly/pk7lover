...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.uname'
        db.add_column('albums_photo', 'uname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.uname'
        db.delete_column('albums_photo', 'uname')
    ...
    models = {
        ...
        'albums.photo': {
            ...
            'uname': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'}),
