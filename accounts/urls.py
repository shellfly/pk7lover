...
urlpatterns = patterns('accounts.views',
                       ...
                       url(r'^(?P<username>\w+)/lefts/$','leftrights',{'friend_type':'left'},name="7lefts"),
                       url(r'^(?P<username>\w+)/rights/$','leftrights',{'friend_type':'right'},name="7rights"),
                       url(r'^group/(?P<id>\d+)/$','group',name='7group'),
                       ...
                       url(r'^eyeon/(?P<username>\w+)/$','eyeon',name="7eyeon"),
                       url(r'^eyeoff/(?P<username>\w+)/$','eyeoff',name="7eyeoff"),
)
