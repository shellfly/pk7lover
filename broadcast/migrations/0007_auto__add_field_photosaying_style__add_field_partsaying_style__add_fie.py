...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoSaying.style'
        db.add_column('broadcast_photosaying', 'style',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=1),
                      keep_default=False)

        # Adding field 'PartSaying.style'
        db.add_column('broadcast_partsaying', 'style',
                      self.gf('django.db.models.fields.CharField')(default='3', max_length=1),
                      keep_default=False)

        # Adding field 'ActivitySaying.style'
        db.add_column('broadcast_activitysaying', 'style',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoSaying.style'
        db.delete_column('broadcast_photosaying', 'style')

        # Deleting field 'PartSaying.style'
        db.delete_column('broadcast_partsaying', 'style')

        # Deleting field 'ActivitySaying.style'
        db.delete_column('broadcast_activitysaying', 'style')
    ...
    models = {
        ...
        'broadcast.activitysaying': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['activity.Activity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 0, 0)'}),
            'style': ('django.db.models.fields.CharField', [], {'default': "'2'", 'max_length': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'broadcast.partsaying': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 0, 0)'}),
            'style': ('django.db.models.fields.CharField', [], {'default': "'3'", 'max_length': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'work': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['activity.Photograph']"})
        },
        'broadcast.photosaying': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 26, 0, 0)'}),
            'style': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
