...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('broadcast_partsaying', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 26, 0, 0))),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activity.Activity'])),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activity.Photograph'])),
        ))
